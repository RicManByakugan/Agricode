...
<head>
  ...
  <title>AGRICODEADMIN | Connexion</title>
...
<div class="login-box">
  <div class="login-logo">
      <img src="data/logo.jpg" class="img-responsive" width="70" height="70" />
  </div>
  <div class="card">
    <div class="card-body login-card-body">
      <p class="login-box-msg">MAGRITECH</p>
      ...
      <div class="row">
        ...
        <div class="col">
         <h6 align="right"><small>MAGRITECH Hackathon</small></h6> 
        </div>
      </div>
    </div>
  </div>
